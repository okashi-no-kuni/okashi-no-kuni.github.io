...
const ART = {
  ...
  オオカミ: { key:'wolf', p:'A fluffy grey wolf cub standing on all four legs, its body turned to the side and its head turned to face the viewer, big round head, soft rounded ears, a thick pale ruff at the chest, cream muzzle, chest and paws, big round dark eyes with white highlights, round pink cheeks and a small closed smiling mouth, no fangs, a big soft bushy tail curving up behind.' },
