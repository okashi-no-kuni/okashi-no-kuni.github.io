...
const ART = {
  ...
  スナネコ: { key:'sandcat', p:'A sand cat sitting upright on its haunches facing the viewer, its tail curled around its front paws. A very pale sandy cream coat, almost white with a faint warm pink tint, and a white chest - clearly paler and cooler than a brown teddy bear - with a round flat cat face, small low triangular ears, short whiskers and a small pink nose, and a thin soft tan outline so it stays visible on a pale background. It is a small round sitting cat - it must not have large upright ears and must not stand on all four legs.' },
  ...
  クレオパトラ: { key:'cleopatra', p:'A small cute Egyptian queen standing on two legs facing the viewer. A straight glossy dark plum bob of hair cut level at her chin with a straight fringe, a slim pale gold circlet across her forehead, a wide flat collar of pale gold and soft turquoise around her shoulders, and a simple long cream linen dress. Calm gentle expression.' },
  ファラオ: { key:'pharaoh', p:'A small cute Egyptian pharaoh standing on two legs facing the viewer. He wears a wide nemes headcloth striped in rich warm gold and soft turquoise that flares out in two broad panels down to his shoulders, making his head much wider than his body, a wide flat collar of warm gold and turquoise, and a short cream linen kilt. He holds a small rounded gold crook and a small gold flail crossed in front of his chest. Warm gold should clearly dominate his colours. Calm kind expression.' },
