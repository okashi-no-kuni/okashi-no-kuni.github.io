...
const ART = {
  ...
  マカロンタワー: { key:'tower', p:'A pyramid of macarons in exactly four rows, counted from the top: row 1 is a single macaron, row 2 has exactly two macarons, row 3 has exactly three, row 4 at the bottom has exactly four. Exactly ten macarons in total. Do not add any further row and do not repeat a row count. All the same size, in peach blossom pink, pale sky blue, lavender and mint, with the peach blossom pink and the sky blue used the most. The pink is a soft rosy pink with only a hint of warmth, never orange or salmon. Each is a proper macaron with two round shells and a filling. The face is on the single macaron at the top.' },
